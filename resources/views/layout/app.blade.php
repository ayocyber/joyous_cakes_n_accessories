        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between h-[68px]">
                ...
                <div class="flex items-center gap-2">
                    <!-- Search -->
                    <button class="hidden md:flex items-center gap-2 bg-purple-50 border border-purple-100 rounded-full px-4 py-2 text-sm text-gray-400 hover:border-plum hover:bg-plum-light transition-all duration-200 group">
                        <svg class="w-3.5 h-3.5 group-hover:text-plum transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
